...
# the external model (GFS) that the initial and lateral boundary 
...
#
# GFS_FILE_FMT_ICS:
# If using the GFS model as the source of the ICs (i.e. if EXTRN_MDL_NAME_ICS
# is set to "GFS"), this variable specifies the format of the model
# files to use when generating the ICs.
#
# GFS_FILE_FMT_LBCS:
# If using the GFS model as the source of the LBCs (i.e. if 
# EXTRN_MDL_NAME_LBCS is set to "GFS"), this variable specifies the 
...
# Number of cores.
#
NCORES_ANALYSIS_GSI="4"
NCORES_RUN_OBSERVER="4"
NCORES_ANALYSIS_ENKF="4"
NATIVE_FORECAST="--cpus-per-task 2 --exclusive"
NATIVE_ANALYSIS_GSI="--cpus-per-task 2 --exclusive"
NATIVE_ANALYSIS_ENKF="--cpus-per-task 4 --exclusive"
#
...
WTIME_ANALYSIS_GSIDIAG="00:15:00"
WTIME_UPDATE_LBC_SOIL="00:30:00"
WTIME_ANALYSIS_ENKF="01:00:00"
WTIME_RECENTER="01:00:00"
WTIME_PROCESS_RADAR="00:25:00"
WTIME_PROCESS_LIGHTNING="00:25:00"
WTIME_PROCESS_BUFR="00:25:00"
WTIME_PROCESS_SMOKE="00:25:00"
WTIME_ANALYSIS_NONVARCLD="00:20:00"
WTIME_BUFRSND="00:45:00"
...
START_TIME_PROCESS_LIGHTNING="00:45:00"
START_TIME_PROCESS_SMOKE="00:45:00"
#
# Memory.
#
MEMO_PROCESS_BUFR="20G"
MEMO_ANALYSIS_NONVARCLD="20G"
MEMO_PRDGEN="24G"
MEMO_PREP_CYC="40G"
MEMO_SAVE_RESTART="40G"
MEMO_SAVE_INPUT="40G"
MEMO_PROCESS_SMOKE="40G"
MEMO_PROCESS_LIGHTNING="70G"
